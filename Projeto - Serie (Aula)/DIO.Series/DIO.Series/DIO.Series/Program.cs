...
namespace DIO.Series
{
    class Program
    {
        ...
        private static void InserirSerie()
        {
            ...
            Console.Write("Digito título da série: ");
        ...
        private static void AtualizarSerie()
        {
            ...
            Serie atualizarSerie = new Serie(id: indiceSerie, genero: (Genero)entradaGenero, titulo: entradaTitulo, descricao: entradaDescricao, ano: entradaAno);
